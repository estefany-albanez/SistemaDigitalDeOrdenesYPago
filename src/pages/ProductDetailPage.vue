    ...
    <q-card v-if="product" class="product-card shadow-2">
      <div class="row no-wrap">
        <div class="col-xs-12 col-md-6 q-pa-md flex flex-center">
          <q-img :src="product.image" alt="Imagen del producto" fit="contain" class="product-image" />
        </div>
        <div class="col-xs-12 col-md-6 q-pa-md">
          ...
          <div class="row items-center q-mb-md">
            ...
            <q-btn icon="remove" color="grey-7" flat dense @click="decreaseQuantity" :disable="quantity <= 1" />
            <span class="text-h6 q-mx-md">{{ quantity }}</span>
            <q-btn icon="add" color="grey-7" flat dense @click="increaseQuantity" />
          </div>
          <q-btn label="Añadir al Carrito" color="primary" icon="add_shopping_cart" class="full-width q-mt-md"
            @click="addToCart" />
          <q-btn label="Volver a la Tienda" flat color="secondary" class="full-width q-mt-sm"
            @click="router.push('/')" />
        </div>
      </div>
    </q-card>
...
const allProducts = [
  {
    ...
    description: 'Nuestra pizza de pepperoni extra grande, con una generosa capa de queso mozzarella derretido y rodajas de pepperoni crujiente. Perfecta para compartir o disfrutar solo.',
    price: 15.99,
  ...
  },
  {
    ...
    description: 'Una hamburguesa gourmet con 1/2 libra de carne de res premium, queso cheddar madurado, crujiente bacon ahumado, lechuga fresca, tomate y nuestra salsa secreta, todo en un pan brioche tostado.',
    price: 10.50,
  ...
  },
  {
    ...
    description: 'Deliciosa ensalada César con lechuga romana crujiente, jugoso pollo a la parrilla, crutones caseros y un cremoso aderezo César, espolvoreada con queso parmesano.',
    price: 8.75,
  ...
  },
  {
    ...
    description: 'Elige tu bebida favorita de nuestra amplia selección de refrescos. Tamaño grande para refrescarte al máximo.',
    price: 2.50,
  ...
  },
  {
    ...
    description: 'Nuestro famoso brownie de chocolate, húmedo y denso, con trozos de chocolate derretido. Ideal para los amantes del cacao.',
    price: 4.00,
